...
import { GetPaymentMethodInter } from '@/NoDomain/Utils-H/feesControl/feesInter'
...
const page = async ({
  ...
  // const apiData: GetPaymentMethodInter[] | any = await getData(PaymentMethodUrl, {...searchParams});
