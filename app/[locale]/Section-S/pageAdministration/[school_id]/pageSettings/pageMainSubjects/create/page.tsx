import { MainSubjectUrl } from '@/NoDomain/Utils-S/appControl/appConfig';
...
const Create = async ({ params }: any) => {
  ...
  const onSubmitServerAction = async (formData: FormData) => {
    ...
    const response = await ActionCreate(data, SchemaCreateEditMainSubject, protocol + MainSubjectUrl, `/Section-S/pageAdministration/${params.school_id}/pageSettings/pageMainSubjects`)
