...
import { SchemaCreateEditSecSchoolFees, SchemaCreateEditTransactions } from '@/NoDomain/Utils-S/schemas/schemas';
import NotificationError from '@/section-s/common/NotificationError';
import { GetSecSchoolFeesUrl, GetSecTransactionUrl, SecSchoolFeesUrl, SecTransactionUrl } from '@/NoDomain/Utils-S/feesControl/feesConfig';
...
const page = async ({
    ...
    const onCreateSchooFeesServerAction = async (formData: FormData) => {
        ...
        const response = await ActionCreate(data, SchemaCreateEditSecSchoolFees, SecSchoolFeesUrl)
