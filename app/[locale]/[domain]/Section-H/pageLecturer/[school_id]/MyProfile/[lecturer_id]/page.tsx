...
const page = async ({
  ...
  const userData: any = await getData(protocol + "api" + params.domain + GetCustomUserUrl, { ...searchParams, id: params.lecturer_id })
...
// 'use client';
// import { getData } from '@/functions';
// import { CustomUserUrl } from '@/Domain/UserControl/userConfig';
// import { CustomUserInter } from '@/Domain/UserControl/userInter';
