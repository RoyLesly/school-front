...
const page = async ({
  ...
  const acadYears = await getData(protocol + "api" + params.domain + AcademicYearUrl, { nopage: true })
  ...
  console.log(specialtyLevelCountChartData, 40)
...
const AdminPage = (
  ...
  return (
    <div className="bg-slate-400 dark:bg-teal-800 flex flex-col gap-4 p-4 rounded-lg">
      ...
      <div className="flex flex-col gap-2 items-center justify-between md:flex-row rounded text-black">
