    ...
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
      ...
      <div className="flex flex-wrap gap-4 justify-between">
        ...
        {/* <div className="flex flex-col gap-2 md:w-1/4 w-full">
          ...
          <select
            className="p-2 ring-[1.5px] ring-gray-300 rounded-md text-sm w-full"
            {...register("sex")}
        ...
        <div className="flex flex-col gap-2 justify-center md:w-1/4 w-full">
          <label
            className="cursor-pointer flex gap-2 items-center text-gray-500 text-xs"
            htmlFor="img"
          >
