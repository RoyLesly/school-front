...
const page = async ({
  ...
  const apiData: CustomUserInter[] | any = await getData(protocol + "api" + params.domain + GetCustomUserUrl, {...searchParams, role: "student", school__id: params.school_id, is_superuser: false});
  ...
  return (
    <LayoutAdmin>
      ...
      <Breadcrumb
          ...
          link2={`/${params.domain}/Section-H/pageAdministration/pageUsers`}
        />
  ...
  return (
    <div className="bg-white border border-stroke dark:bg-boxdark dark:border-strokedark rounded-sm shadow-default">
      ...
      <MyPagination
        ...
        count={apiData.count}
        thisUrl={`/${params.domain}/Section-H/pageAdministration/${params.school_id}/pageUsers/pageStutsUsers`}
      />
...
const SearchUser = ({ params }: any) => {
  const onSearchDrugServerAction = async (formData: FormData) => {
    ...
    if (full_name) {
        redirect(`/${params.domain}/Section-H/pageAdministration/${params.school_id}/pageUsers/pageStutsUsers?full_name=${full_name}`)
    }
  ...
  return (
      <>
          ...
          <form action={onSearchDrugServerAction} className='flex flex-row gap-1'>
              ...
              <Link className='flex items-center justify-center' href={`/${params.domain}/Section-H/pageAdministration/${params.school_id}/pageUsers/pageStutsUsers`}><FiRefreshCw size={23} /></Link>
          </form>
