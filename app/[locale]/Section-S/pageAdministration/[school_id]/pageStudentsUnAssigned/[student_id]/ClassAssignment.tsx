...
import { GetClassroomInter, GetLevelInter } from '@/NoDomain/Utils-S/appControl/appInter';
    ...
    useEffect(() => {
        ...
        if (count == 1 && selDomain && selAcademicYear.length > 4 && selLevelID) {
            const GetSpecialties = async () => {
                var res = await getData(protocol + GetClassroomUrl, { main_specialty__field__domain__id: selDomain, level__id: selLevelID, academic_year: selAcademicYear, school__campus__id: school_id, fieldList: [ 
