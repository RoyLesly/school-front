...
const page = async ({
  ...
  if (session.isLoggedIn){
    revalidatePath(`/pageAdministration/${params.school_id}/pageStudents`)
    ...
    const Pages: PageProps[] = [
      { id: 1, title: "Domains", link: `/pageAdministration/${params.school_id}/pageSettings/pageDomains` },
      { id: 2, title: "Fields", link: `/pageAdministration/${params.school_id}/pageSettings/pageFields` },
      { id: 3, title: "Specialties", link: `/pageAdministration/${params.school_id}/pageSettings/pageSpecialties` },
      { id: 4, title: "Specialty Titles", link: `/pageAdministration/${params.school_id}/pageSettings/pageMainSpecialties` },
      { id: 5, title: "Courses", link: `/pageAdministration/${params.school_id}/pageSettings/pageCourses` },
      { id: 6, title: "Course Titles", link: `/pageAdministration/${params.school_id}/pageSettings/pageMainCourses` },
    ]
