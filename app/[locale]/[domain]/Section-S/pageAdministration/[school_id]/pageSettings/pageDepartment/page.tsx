...
import { GetDepartmentUrl } from '@/Domain/Utils-S/userControl/userConfig'
...
const page = async ({
  ...
  const apiData: any = await getData(protocol  + "api" + params.domain + GetDepartmentUrl, {...searchParams, nopage: true});
