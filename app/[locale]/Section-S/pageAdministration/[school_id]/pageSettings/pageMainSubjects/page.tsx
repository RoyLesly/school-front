...
import { MainSubjectInter } from '@/NoDomain/Utils-S/appControl/appInter'
...
const page = async ({
  ...
  const apiData: MainSubjectInter[] | any = await getData(protocol + GetMainSubjectUrl, {...searchParams, fieldList: ["id", "subject_name" ]});
