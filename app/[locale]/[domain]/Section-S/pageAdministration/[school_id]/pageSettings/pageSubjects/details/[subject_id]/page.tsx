import { GetSubjectUrl, GetMainSubjectUrl, GetClassroomUrl, SubjectUrl } from '@/Domain/Utils-S/appControl/appConfig';
import { GetSubjectInter, GetMainSubjectInter, GetClassroomInter} from '@/Domain/Utils-S/appControl/appInter';
...
const page = async ({
    ...
    params: { school_id: string, subject_id: string, domain: string };
    searchParams?: { [key: string]: string | string[] | undefined };
}) => {

    const apiData: any = await getData(protocol  + "api" + params.domain + GetSubjectUrl, { id: params.subject_id, fieldList: [ 
...
const EditDelete: FC<EditDeleteProps> = async ({ apiData, params }) => {
    ...
    const onSubmitDeleteAction = async () => {
        ...
        const response = await ActionDelete(SubjectUrl, params.subject_id)
