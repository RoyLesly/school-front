...
import { ProgramInter } from '@/NoDomain/Utils-S/userControl/userInter'
    ...
    <LayoutAdmin>
      <>
        <Breadcrumb
          ...
          link2={`/pageAdministration/${params.school_id}/pageUtilities`}
        />
  ...
  return (
    <div className="bg-white border border-stroke dark:bg-boxdark dark:border-strokedark rounded-sm shadow-default">
      <div className="flex justify-between md:px-6 px-4 py-6 xl:px-7.5">
        ...
        <MyButtonCustom
          title="Add Program"
          href={`/pageAdministration/${params.school_id}/pageSettings/pagePrograms/create`} 
        />
      </div>
        ...
        >
          ...
          <div className="flex gap-2 items-center justify-end px-2 w-full">
            <MyButtonCustom
              type='edit'
              title="View"
              href={`/pageAdministration/${params.school_id}/pageSettings/pagePrograms/details/${item.id}`}
            />
          </div>
        </div>
      ))}
      ...
      <MyPagination
        ...
        count={apiData.count}
        thisUrl={"/pageAdministration/pageSettings/pagePrograms"}
      />
