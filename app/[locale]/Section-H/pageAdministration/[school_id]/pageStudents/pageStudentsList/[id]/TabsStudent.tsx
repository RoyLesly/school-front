...
const TabsStudent = ({ params }: any) => {
  ...
  const Tabs: { id: number, link: string, name: string}[] = [
    { id: 1, link: `/Section-H/pageAdministration/pageStudents/details/${params.id}`, name: "Personal Info"},
    { id: 2, link: `/Section-H/pageAdministration/pageStudents/details/${params.id}/specialties`, name: "Specialties"},
    { id: 3, link: `/Section-H/pageAdministration/pageStudents/details/${params.id}/fees`, name: "Fees"},
  ]
