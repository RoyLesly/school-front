...
import ListTranscriptApprovedPage from '@/componentsTwo/ListResult/ListTranscriptApprovedPage'
...
const page = async ({
  ...
  const apiTranscriptApplications: any = await getData(protocol + "api" + params.domain + GetTranscriptApplicationUrl, { nopage: true, status: "APPROVED", ...searchParams, fieldList: [
  ...
  return (
    <LayoutAdmin>
      <>
        ...
        {apiTranscriptApplications && <ListTranscriptApprovedPage params={params} data={apiTranscriptApplications} />}
