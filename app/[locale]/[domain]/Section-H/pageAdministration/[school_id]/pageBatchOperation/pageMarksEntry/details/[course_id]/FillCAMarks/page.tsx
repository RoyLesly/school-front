...
const EditPage = async ({
  ...
  const apiData: any = await getData(protocol + "api" + params.domain + GetResultUrl, { nopage: true, course__semester: searchParams?.ca, course__id: params.course_id, active: true, fieldList: [
    "id", 
    "student__id",
