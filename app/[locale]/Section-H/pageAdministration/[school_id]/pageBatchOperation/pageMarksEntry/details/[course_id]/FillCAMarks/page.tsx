...
const EditPage = async ({
  ...
  const apiData: any = await getData(protocol + GetResultUrl, { nopage: true, course__semester: searchParams?.ca, course__id: params.course_id, active: true, fieldList: [
    "id", 
    "student__id",
  ...
  return (
    <LayoutAdmin>
      <>
        <Breadcrumb
          pageName="CA Marks (Continous Assessment)" 
          pageName1="Back" 
