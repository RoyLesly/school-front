...
import { GetSubjectInter, GetLevelInter } from '@/Domain/Utils-S/appControl/appInter'
import { getData } from '@/functions'
import { GetSubjectUrl, GetLevelUrl } from '@/Domain/Utils-S/appControl/appConfig'
...
const page = async ({
  ...
  const apiData: any = await getData(protocol  + "api" + params.domain + GetSubjectUrl, { ...searchParams, specialty__school__id: params.school_id, fieldList: [
    "id", 
