...
const EditPage = async ({
  ...
  const apiData: any = await getData(protocol + GetResultUrl, { nopage: true, course__semester: searchParams?.exam, course__id: params.course_id, active: true, fieldList: [
    "id", 
    "student__id",
    ...
    <LayoutAdmin>
      <>
        <Breadcrumb
          pageName="EXAM Marks" 
          pageName1="Back" 
          link1={`/Section-H/pageAdministration/${params.school_id}/pageBatchOperation/pageMarksEntry/details/${params.course_id}`}
        />
