...
const DropdownUser = () => {
  ...
  const DeptLinkList: string[] = [
    '/Section-S/pageAccounting',
    '/Section-S/pageLecturer',
    '/Section-S/pageStudent',
    '/Section-S/pageAdministration',
  ]
