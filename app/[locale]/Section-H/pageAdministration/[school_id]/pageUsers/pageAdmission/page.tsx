...
import { CustomUserUrl, DepartmentUrl } from '@/NoDomain/Utils-H/userControl/userConfig';
...
const Create = async ({ searchParams, params }: any) => {
  ...
  const onSubmitServerAction = async (formData: FormData) => {
    ...
    const response = await ActionCreate(data, SchemaCreateCustomUser, protocol + CustomUserUrl, `/Section-H/pageAdministration/${params.school_id}`)
