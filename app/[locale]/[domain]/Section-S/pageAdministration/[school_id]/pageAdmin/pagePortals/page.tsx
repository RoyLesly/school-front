        ...
        {apiDataI && apiDataI.length > 0 && apiDataI.map((item: GetPublishInter, key: number) => (
          ...
          >
            ...
            <div className="flex items-center justify-center w-32">
              ...
              : 
              <Link href={`/Section-H/pageAdministration/${params.school_id}/pageAdmin/pagePortals/${item.id}?ca=true`}><RiToggleFill color='red' size={40} /></Link>}
          </div>

            <div className="flex items-center justify-center w-32">
              {item.portal_exam ? 
              <Link href={`/Section-H/pageAdministration/${params.school_id}/pageAdmin/pagePortals/${item.id}?exam=false`}><RiToggleFill color='green' size={40} /></Link> 
              : 
              <Link href={`/Section-H/pageAdministration/${params.school_id}/pageAdmin/pagePortals/${item.id}?exam=true`}><RiToggleFill color='red' size={40} /></Link>}
          </div>

            <div className="flex items-center justify-center w-32">
              {item.portal_resit ? 
              <Link href={`/Section-H/pageAdministration/${params.school_id}/pageAdmin/pagePortals/${item.id}?resit=false`}><RiToggleFill color='green' size={40} /></Link> 
              : 
              <Link href={`/Section-H/pageAdministration/${params.school_id}/pageAdmin/pagePortals/${item.id}?resit=true`}><RiToggleFill color='red' size={40} /></Link>}
          </div>
      ...
      <div className='border-2 my-2 rounded'>
        ...
        {apiDataII && apiDataII.length > 0 && apiDataII.map((item: GetPublishInter, key: number) => (
          ...
          >
            ...
            <div className="flex items-center justify-center w-32">
              {item.portal_ca ? 
              <Link href={`/Section-H/pageAdministration/${params.school_id}/pageAdmin/pagePortals/${item.id}?ca=false`}><RiToggleFill color='green' size={40} /></Link> 
              : 
              <Link href={`/Section-H/pageAdministration/${params.school_id}/pageAdmin/pagePortals/${item.id}?ca=true`}><RiToggleFill color='red' size={40} /></Link>}
            </div>
