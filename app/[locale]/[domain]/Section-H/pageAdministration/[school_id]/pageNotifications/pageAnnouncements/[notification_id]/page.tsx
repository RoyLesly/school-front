...
const page = async ({
  ...
  const apiNotification: GetNotificationInter[] | any = await getData( protocol + "api" + params.domain + GetNotificationUrl, { id: params.notification_id, nopage: true, fieldList: [ 
