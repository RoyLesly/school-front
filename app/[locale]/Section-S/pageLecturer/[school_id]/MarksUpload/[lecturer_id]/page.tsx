...
const page = async ({
  ...
  const coursesData: any = await getData(protocol + GetCourseUrl, { ...searchParams, nopage: true, specialty__school__campus__id: params.school_id, assigned_to__id: params.lecturer_id, fieldList: [
    "id", 
