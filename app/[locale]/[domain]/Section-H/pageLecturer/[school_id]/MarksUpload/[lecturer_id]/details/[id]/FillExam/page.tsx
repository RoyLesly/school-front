...
import { CourseInter } from '@/Domain/Utils-H/appControl/appInter';
...
const EditPage = async ({
  ...
  const apiData: any = await getData(protocol + "api" + params.domain + GetResultUrl, { ...searchParams, nopage: true, course__specialty__school__id: params.school_id, course__id: params.id, fieldList: [
    "id", 
    "student__id",
