...
import { GetLevelUrl, GetCourseUrl } from '@/NoDomain/Utils-H/appControl/appConfig';
import { DomainInter, GetLevelInter, GetCourseInter } from '@/NoDomain/Utils-H/appControl/appInter';
        ...
        if (count == 1) {
            ...
            if (selectedDomainID && selectedSpecialtyID && selectedYear) {
                const getCourses = async () => {
                    var res = await getData(protocol + GetCourseUrl, {
