        ...
        <nav className="lg:mt-4 lg:px-6 px-4 py-4">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-1.5 mb-6">
              ...
              <li>
                <Link
                  href={`/pageLecturer/${user?.school}/MyProfile/${user?.id}`}
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("pageDashboard") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
              ...
              <li>
                <Link
                  href={`/pageLecturer/${user?.school}/MyCourses/${user?.id}`}
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("pageDashboard") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
              ...
              <li>
                <Link
                  href={`/pageLecturer/${user?.school}/MarksUpload/${user?.id}`}
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("pageDashboard") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
              ...
              <li>
                <Link
                  href={`/pageLecturer/${user?.school}/MyCourses/${user?.id}`}
                  className={`group hidden relative items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                  // className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("pageDashboard") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
