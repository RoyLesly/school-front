...
import { GetLevelUrl } from '@/NoDomain/Utils-S/appControl/appConfig'
  ...
  return (
    <div className="bg-white border border-stroke dark:bg-boxdark dark:border-strokedark rounded-sm shadow-default">
      <div className="flex justify-between md:px-6 px-4 py-6 xl:px-7.5">
        ...
        <MyButtonCustom
          title="Add Level"
          href={`/Section-S/pageAdministration/${params.school_id}/pageSettings/pageLevels/create`} 
        />
      </div>
        ...
        >
          ...
          <div className="flex gap-2 items-center justify-end md:gap-6 md:text-md px-2 w-full">
            <MyButtonCustom
              type='edit'
              title="View"
              href={`/Section-S/pageAdministration/${params.school_id}/pageSettings/pageLevels/details/${item.id}`}
            />
          </div>
        </div>
      ))}
