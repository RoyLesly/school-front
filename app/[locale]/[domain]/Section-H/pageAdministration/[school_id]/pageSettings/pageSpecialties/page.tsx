...
const page = async ({
  ...
  const apiData: any = await getData(protocol + "api" + params.domain + GetSpecialtyUrl, { ...searchParams, fieldList: [
  ...
  return (
    <LayoutAdmin>
      <>
        ...
        {apiData && apiData.results && <ListSpecialtyPage params={params} data={apiData.results} />}
