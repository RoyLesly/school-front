...
const EditPage = async ({
  ...
  const course = await getData(GetCourseUrl + "/" + params.id, { fieldList: [ "id", "semester", "main_course__course_name", "specialty__id", "specialty__main_specialty__specialty_name" ]})
