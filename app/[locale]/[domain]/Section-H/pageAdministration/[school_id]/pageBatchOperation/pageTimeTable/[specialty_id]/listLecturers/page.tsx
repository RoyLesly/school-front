    ...
    <div className='flex-col flex-grow hidden md:flex'>
      ...
      {specialty && specialty.count ?
        <div className='flex flex-row font-semibold gap-2 items-center justify-between md:text-2xl py-2'>
          <span><Link href={`/${params.domain}/Section-H/pageAdministration/${school_id}/pageBatchOperation/pageTimeTable/${specialty_id}/listCourses`} className='bg-slate-200 px-6 py-1 rounded-sm text-slate-400'>Show Courses</Link></span>
          <span><Link href={`/${params.domain}/Section-H/pageAdministration/${school_id}/pageBatchOperation/pageTimeTable/${specialty_id}/listLecturers`} className='bg-slate-300 px-6 py-1 rounded-sm text-black'>Show Lecturers</Link></span>
          <span className=''><Link className='bg-bluedash flex gap-2 items-center justify-center px-6 py-1 rounded text-white' href={`/${params.domain}/Section-H/pageAdministration/${school_id}/pageBatchOperation/pageTimeTable/${specialty_id}/selectdate`}><FaPlus /><b>Create</b></Link></span>
        </div> : <></>}
