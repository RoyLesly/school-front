...
const EditPage = async ({
  ...
  const course = await getData(protocol + GetCourseUrl + "/" + params.id, { fieldList: [ "id", "semester", "main_course__course_name", "specialty__id", "specialty__main_specialty__specialty_name" ]})
...
const Select:FC<SelectProps> = async ( { params, course }) => {
  ...
  const publish = await getData(GetPublishUrl, { specialty__id: course.specialty__id, fieldList: [ "id", "specialty__id", "semester", "ca", "portal_ca", "portal_exam", "portal_resit" ]})
