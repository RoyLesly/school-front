...
const SearchLecturer = ({ apiLecturer, updateCourseAssignedTo, item }: any) => {
    ...
    return (
        <div className="col-span-2 flex-col items-center justify-center md:flex mx-0 px-0">
            ...
            />
            <select defaultValue={item.assigned_to_id} onChange={(e) => { updateCourseAssignedTo(item.main_subject_id, parseInt(e.target.value)) }} className='border-2 px-1 py-1 rounded w-40'>
