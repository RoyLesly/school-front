...
const page = async ({
  ...
  const apiData: CustomUserInter[] | any = await getData(protocol + GetCustomUserUrl, { ...searchParams, nopage: true, role: "teacher", school__id: params.school_id, is_superuser: false });
