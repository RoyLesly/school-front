...
const page = async ({
  ...
  const apiData: any = await getData(protocol + "api" + params.domain + GetCourseUrl, { ...searchParams, fieldList: [
    "id", "main_course__course_name", "main_course__id", "course_code", "course_type", "course_credit", "semester", "hours", "hours_left", 
    "assigned_to__full_name", "assigned_to__id", "assigned", "semester",
  ...
  return (
    <LayoutAdmin>
      <>
        ...
        {apiData && apiData.results && <ListCoursePage params={params} data={apiData.results} />}
