...
const page = async ({
  ...
  const coursesData: any = await getData(GetCourseUrl, { ...searchParams, nopage: true, assigned_to__id: params.lecturer_id, specialty__school__campus__id: params.school_id, fieldList: [
    "id", 
