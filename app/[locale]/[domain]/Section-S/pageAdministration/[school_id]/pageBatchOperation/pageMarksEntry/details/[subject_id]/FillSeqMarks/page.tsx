...
const EditPage = async ({
  ...
  const apiData: any = await getData(protocol + GetResultUrl, { ...searchParams, subject__id: params.subject_id, active: true, fieldList: [
    "id", 
    "student__id",
    ...
    <LayoutAdmin>
      <>
        <Breadcrumb
          pageName="Exam Marks" 
          pageName1="Back" 
          link1={`/Section-H/pageAdministration/${params.school_id}/pageBatchOperation/pageMarksEntry/details/${params.subject_id}`}
        />
