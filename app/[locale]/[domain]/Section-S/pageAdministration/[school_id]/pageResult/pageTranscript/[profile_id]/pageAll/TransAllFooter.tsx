import { GetResultInter, GetSchoolInfoInter } from '@/Domain/Utils-S/appControl/appInter'
...
const TransAllFooter:FC<TransFooterProps> = async ({ results, schoolinfo }: any) => {
    ...
    return (
        <div className='border-2 flex flex-row gap-2 h-[190px] pl-2 pt-4 text-black'>
            ...
            <div className='flex flex-col px-2 w-[600px]'>
                <div className="font-medium grid grid-cols-3 h-[18px] pl-4">
                    ...
                    <div className='col-span-1 flex flex-col items-center justify-center text-[14px]'>
                        {results.total_subject_attempted}
                    </div>
                </div>
