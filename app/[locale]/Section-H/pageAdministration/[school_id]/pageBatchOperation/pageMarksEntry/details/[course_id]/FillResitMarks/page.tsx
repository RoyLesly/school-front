...
const EditPage = async ({
  ...
  const apiData: any = await getData(protocol + GetResultUrl, { nopage: true, course__semester: searchParams?.resit, course__id: params.course_id, active: true, fieldList: [
    "id", 
    "student__id",
