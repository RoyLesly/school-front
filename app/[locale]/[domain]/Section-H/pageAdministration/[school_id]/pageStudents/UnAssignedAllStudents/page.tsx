...
import ListStudUnAssAllPage from '@/componentsTwo/ListProfiles/ListStudUnAssAllPage'
...
const page = async ({
  ...
  const apiData: any = await getData(protocol + "api" + params.domain + GetUserProfileUrl, {
    user__role: "student", nospecialty: true, nopage: true, ...searchParams, fieldList: [
