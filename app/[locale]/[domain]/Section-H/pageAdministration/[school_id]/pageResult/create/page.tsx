...
import { GetCourseUrl, ResultUrl } from '@/Domain/Utils-H/appControl/appConfig';
...
const page = async ({
    ...
    const subj: GetCourseInter[] = await getData(protocol + "api" + params.domain + GetCourseUrl, {
...
const Create = async ({ subject, params, searchParams }: any) => {
    ...
    const students: GetUserProfileInter[] = await getData(protocol + "api" + params.domain + GetUserProfileUrl, { nopage: true, specialty__id: subject.specialty__id, fieldList: ["id", "user__telephone", "user__full_name", "user__matricle"] })
