...
const page = async ({
  ...
  const apiSchool: GetSchoolInfoInter[] | any = await getData(GetSchoolInfoUrl, { nopage: true, id: params.school_id })
        ...
        {apiSchool && apiSchool.length == 1 &&
          <div className='bg-blue-100 flex flex-col gap-20 h-screen items-center justify-center px-10 tracking-widest'>
              ...
              <Image
                width={200}
                height={200}
                src={ConfigData["local"].Logo.lg512.s}
                alt="Logo"
            ...
            <div className="flex md:hidden">
              <Image
                width={130}
                height={130}
                src={ConfigData["local"].Logo.sm256.s}
                alt="Logo"
                style={{ borderRadius: 150 }}
                priority
              />
            ...
            <Link href={`/Section-S/pageAdministration/${params.school_id}/pageDashboard`} className="bg-blue-700 font-medium px-10 py-2 rounded text-white text-xl">Continue</Link>
          </div>
        }
      </>
