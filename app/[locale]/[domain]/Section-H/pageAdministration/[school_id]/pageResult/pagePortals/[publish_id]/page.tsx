...
const PublishConfirm = ({ apiData, params, searchParams }: any) => {
  ...
  const onSubmitSearchAction = async () => {
    ...
    if (response.id == apiData.id) {
      if (value) {
        redirect(`/${params.domain}/Section-H/pageAdministration/${params.school_id}/pageResult/pagePortals?success=Portal Openned Successfully`)
      }
      redirect(`/${params.domain}/Section-H/pageAdministration/${params.school_id}/pageResult/pagePortals?success=Portal Closed Successfully`)
