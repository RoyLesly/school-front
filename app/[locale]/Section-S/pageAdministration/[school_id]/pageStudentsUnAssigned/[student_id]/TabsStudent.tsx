...
const TabsStudent = ({ params, page }: any) => {
  ...
  const Tabs: { id: number, link: string, name: string}[] = [
    { id: 1, link: `/Section-S/pageAdministration/${params.school_id}/pageStudentsUnAssigned/${params.student_id}`, name: "Assign Class"},
    // { id: 2, link: `/pageAdministration/${params.school_id}/pageStudentsUnAssigned/${params.student_id}/info`, name: "Personal Info"},
    // { id: 3, link: `/pageAdministration/${params.school_id}/pageStudentsUnAssigned/${params.student_id}/fees`, name: "Fees"},
  ]
