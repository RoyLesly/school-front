...
import { FieldInter } from '@/Domain/Utils-H/appControl/appInter';
import { FieldUrl } from '@/Domain/Utils-H/appControl/appConfig';
import { protocol } from '@/config';

const Fields = async ({ params }: any) => {

  const apiData: FieldInter[] | any = await getData(protocol + "api" + params.domain +FieldUrl + `?domain_id=${params.id}`, {});
