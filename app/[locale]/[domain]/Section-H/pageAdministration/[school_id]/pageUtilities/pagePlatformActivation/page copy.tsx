...
const page = async ({
  ...
  const apiNotActiveAccounts: any = await getData(protocol + "api" + params.domain + GetSchoolFeesUrl, { userprofile__specialty__school__campus__id: params.school_id, platform_paid: false, userprofile__no_specialty: false, fieldList: [ 
  ...
  return (
    <LayoutAdmin>
      <>
        ...
        {apiNotActiveAccounts && apiNotActiveAccounts.unauthorized && redirect(`/Section-H/pageAuthentication/pageSessionExpired`)}
