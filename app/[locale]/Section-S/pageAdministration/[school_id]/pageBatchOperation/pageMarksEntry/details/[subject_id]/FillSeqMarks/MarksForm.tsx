...
import { ResultUrl } from '@/NoDomain/Utils-S/appControl/appConfig';
import { GetResultInter } from '@/NoDomain/Utils-S/appControl/appInter';
import { SchemaCreateEditResult } from '@/NoDomain/Utils-S/schemas/schemas';
        ...
        if (token && token.user_id && ArrayMarksToSubmit && ArrayMarksToSubmit.length > 0) {           
            ...
            .then(res => {
                ...
                if (res && res.length > 0) {
                    ...
                    router.push(`/pageAdministration/${params.school_id}/pageBatchOperation/pageMarksEntry?updated="SUCCESSFULLY !!!`);
                }
            })
            .catch(err => {
                console.log(98, err)
