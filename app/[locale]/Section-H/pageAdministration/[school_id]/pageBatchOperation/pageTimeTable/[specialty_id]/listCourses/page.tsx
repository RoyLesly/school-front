    ...
    <LayoutAdmin>
      <>
        <Breadcrumb
          ...
          pageName1="Dashboard"
          pageName2="Back"
          link1={`/Setion-H/pageAdministration/${params.school_id}`}
          link2={`/Setion-H/pageAdministration/${params.school_id}/pageBatchOperation/pageTimeTable`}
        />
...
const List = async ({ data, specialty, school_id, specialty_id }: any) => {
  ...
  console.log(period, 65)

  return <>
    <div className='bg-white flex-col flex-grow hidden md:flex p-4 rounded'>

      {specialty && specialty.count ?
        <div className='flex flex-row font-medium gap-2 items-center justify-between md:text-2xl py-2'>
          <span><Link href={`/Section-H/pageAdministration/${school_id}/pageBatchOperation/pageTimeTable/${specialty_id}/listCourses`} className='bg-slate-400 px-6 py-1 rounded-sm text-black'>Show Courses</Link></span>
          <span><Link href={`/Section-H/pageAdministration/${school_id}/pageBatchOperation/pageTimeTable/${specialty_id}/listLecturers`} className='bg-slate-200 px-6 py-1 rounded-sm text-slate-400'>Show Lecturers</Link></span>
