...
import { GetResultTranscriptUrl, GetSchoolInfoUrl } from '@/NoDomain/Utils-H/appControl/appConfig'
...
const page = async ({
    ...
    const apiMyResultsI: any = await getData(protocol + GetResultTranscriptUrl, { student__id: params.profile_id, course__semester: "I", fieldList: ["id", "course__main_course__course_name", "course__course_code", "course__course_credit", "course__semester", "ca", "exam", "resit", "average", "validated", "wp"] });
    const apiMyResultsII: any = await getData(protocol + GetResultTranscriptUrl, { student__id: params.profile_id, course__semester: "II", fieldList: ["id", "course__main_course__course_name", "course__course_code", "course__course_credit", "course__semester", "ca", "exam", "resit", "average", "validated", "wp"] });
    const apiMyResultsAll: any = await getData(protocol + GetResultTranscriptUrl, { student__id: params.profile_id, fieldList: ["id", "course__main_course__course_name", "course__course_code", "course__course_credit", "course__semester", "ca", "exam", "resit", "average", "validated", "wp"] });
    const apiSchoolFees: any = await getData(protocol + GetSchoolFeesUrl, { userprofile__id: params.profile_id, fieldList: ["id", "platform_charges", "platform_paid", "balance"] });
    const apiSchoolInfo: any = await getData(protocol + GetSchoolInfoUrl, { campus__id: params.school_id, fieldList: ["id", "school_name", "address", "town", "po_box", "email", "telephone_one", "niu", "region", "country", "website"] });
    const apiStudentInfo: any = await getData(protocol + GetUserProfileUrl, { id: params.profile_id, fieldList: ["id", "user__matricle", "user__full_name", "user__sex", "user__dob", "user__email", "user__telephone", "specialty__main_specialty__specialty_name", "specialty__academic_year", "specialty__level__level", "specialty__main_specialty__field__field_name", "specialty__main_specialty__field__domain__domain_name"] });
