...
import { GetSecTransactionUrl } from '@/NoDomain/Utils-S/feesControl/feesConfig';
import { GetSecTransactionsInter } from '@/NoDomain/Utils-S/feesControl/feesInter';
    ...
    <LayoutAdmin>
      <>
        <Breadcrumb
          ...
          pageName1="Back"
          link1={`/pageAdministration/${params.school_id}/pageStudents/details/${params.student_id}/fees`}
        />
