...
const TransFooter = async ({ resultAll, schoolinfo }: any) => {
    ...
    return (
        <div className='border-2 flex flex-row gap-2 h-[120px] pl-2 text-black'>
            ...
            <div className='flex-col hidden text-[11px] text-xs w-[243px]'>
            ...
            {/* <div className='flex flex-col w-[320px]'> */}
                ...
                <div className="border flex font-medium h-[16px] items-center justify-between w-full">
                    <div className='items-start justify-center text-[12px]'>
                        Total Credit
                    </div>
                    <div className='items-start justify-center text-[12px]'>
                        Attempted - {resultAll.total_credit_attempted}
                    </div>
                    <div className='items-start justify-center text-[12px]'>
                        Earned - {resultAll.total_credit_earned}
                    </div>
                </div>
                ...
                {/* <div className="font-medium gap-0 grid grid-cols-3 mt-2">
                ...
                <div className="font-medium grid grid-cols-3 h-full">
                    <div className='col-span-2 flex flex-col items-start justify-center text-[12px]'>
                        The DIRECTOR
                    </div>
                </div>
                ...
                <div className="font-medium grid grid-cols-12 h-[16px] mb-1">
                    <div className='capitalize col-span-12 flex flex-row gap-2 items-start justify-start text-[12px]'>
                        Done in {schoolinfo.town}, <span className='italic'>{new Date().toUTCString().slice(0, 16)}</span>
                    </div>
                </div>
            </div>
        </div>
