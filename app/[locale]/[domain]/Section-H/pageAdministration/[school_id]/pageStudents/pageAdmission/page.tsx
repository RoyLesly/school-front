    ...
    <LayoutAdmin>
      <>
        <Breadcrumb
          ...
          pageName1="Students"
          link1={`/${params.domain}/Section-H/pageAdministration/pageStudents`}
        />
...
const Create = async ({ params }: any) => {
  ...
  const deptData: DeptInter[] | any = await getData(protocol + "api" + params.domain + DepartmentUrl, { name: "Student" });
  ...
  const onSubmitServerAction = async (formData: FormData) => {
    ...
    if (response.id) {
      ...
      if (response2.error) {
        redirect(`/${params.domain}/Section-H/pageAdministration/${params.school_id}/pageStudents/create?error=${JSON.stringify(response.error)}`)
      }
      if (response2.errors) {
        redirect(`/${params.domain}/Section-H/pageAdministration/${params.school_id}/pageStudents/create?error=${JSON.stringify(response.errors)}`)
      }
      if (response2?.detail) {
        redirect(`/${params.domain}/Section-H/pageAdministration/${params.school_id}/pageStudents/create?error=${JSON.stringify(response.detail)}`)
      }
    ...
    if (response?.telephone) {
      redirect(`/${params.domain}/Section-H/pageAdministration/${params.school_id}/pageStudents/create?error=${JSON.stringify(response.telephone)}`)
    }
    if (response?.email) {
      redirect(`/${params.domain}/Section-H/pageAdministration/${params.school_id}/pageStudents/create?error=${JSON.stringify(response.email)}`)
    }
    redirect(`/${params.domain}/Section-H/pageAdministration/${params.school_id}/pageStudents/create?error=${JSON.stringify(response)}`)
